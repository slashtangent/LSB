...
enum MOBMODIFIER : int
{
    ...
    MOBMOD_DRAW_IN_TRIGGER_DIST   = 81, // Distance to trigger a draw-in (overrides a default of 2 * melee dist)
    MOBMOD_DRAW_IN_MAX_RANGE      = 82, // Max range to draw-in an entity (overrides a default of entire zone)
};
